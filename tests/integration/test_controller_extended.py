...
pytestmark = pytest.mark.skip(reason="Requires complex LangGraph routing and agent coordination setup")
...
class TestComplexRouting:
    ...
    @pytest.mark.asyncio
    async def test_route_from_planning_to_design(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_route_from_design_to_development(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_route_from_development_to_testing(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_route_from_testing_to_delivery(self, controller, sample_workflow_state):
        ...
        sample_workflow_state["quality_gates_passed"] = ["unit_tests", "integration_tests"]
...
class TestStateTransitions:
    ...
    @pytest.mark.asyncio
    async def test_state_checkpoint_on_transition(self, controller, sample_workflow_state):
...
class TestErrorRecoveryRouting:
    ...
    @pytest.mark.asyncio
    async def test_route_to_deviation_handler_on_error(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_route_to_retry_on_transient_error(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_route_to_escalation_on_critical_error(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_route_to_human_approval_on_decision_needed(self, controller, sample_workflow_state):
...
class TestControllerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_workflow_execution_path(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_workflow_with_error_recovery(self, controller, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_workflow_with_human_approval(self, controller, sample_workflow_state):
