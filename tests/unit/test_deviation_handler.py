...
class TestDeviationLogging:
    ...
    @pytest.mark.asyncio
    async def test_log_deviation_with_error(self, deviation_handler, sample_workflow_state):
        """Test logging a deviation with error details."""
        error = ValueError("Test error")
        
        with patch.object(deviation_handler, "logger") as mock_logger:
    ...
    @pytest.mark.asyncio
    async def test_log_deviation_updates_state(self, deviation_handler, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_log_deviation_with_budget_error(self, deviation_handler, sample_workflow_state):
        """Test logging a budget exhaustion deviation."""
        error = BudgetExhaustedError("Budget exceeded")
...
class TestErrorRecovery:
    ...
    @pytest.mark.asyncio
    async def test_attempt_recovery_from_error(self, deviation_handler, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_recovery_increments_rejection_count(self, deviation_handler, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_recovery_with_max_retries_exceeded(self, deviation_handler, sample_workflow_state):
...
class TestStateRollback:
    ...
    @pytest.mark.asyncio
    async def test_rollback_to_previous_state(self, deviation_handler, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_rollback_preserves_workflow_id(self, deviation_handler, sample_workflow_state):
...
class TestEscalation:
    ...
    @pytest.mark.asyncio
    async def test_escalate_to_human_review(self, deviation_handler, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_escalation_with_approval_gate(self, deviation_handler, sample_workflow_state):
...
class TestDeviationHandlerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_error_handling_flow(self, deviation_handler, sample_workflow_state):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_with_escalation(self, deviation_handler, sample_workflow_state):
